<!DOCTYPE html>
<html lang="en" style="background-color: orange; background-size: 100% 100%;">
...
<body class="fix-header fix-sidebar" style="background-color: orange; background-size: 100% 100%;">
